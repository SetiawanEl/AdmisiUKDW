                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="box-title"><a href="index.php"><i class="fa fa-arrow-circle-left"></i></a> | Trend 3 - Detail</h4>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card-body">
                                            <canvas id="Trend3Full" width="200" height="100"></canvas>
                                            </div>
                                                        ...
                                                        <div class="default-tab">
                                                            ...
                                                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                                <div class="tab-pane fade" id="nav-home" role="tabpanel"
                                                                    ...
                                                                    <?php
                                                                        $no= 1;
                                                                        $result = $conn->query("select a.Jurusan_3 as j1, a.Pendaftar as p1, a.Diterima as d1,a.Regis as r1 FROM trend_3 a");
